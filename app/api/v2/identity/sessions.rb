  ...
  module Identity
    class Sessions < Grape::API
      ...
      resource :sessions do
        ...
        delete do
          if auth_method == 'password' || auth_method == 'auth0'
        ...
        params do
          ...
          requires :algo, type: String, desc: 'Auth Algorithm'
        ...
        post '/signature' do
          ...
          verify_captcha!(response: params[:captcha_response], endpoint: 'session_signature_create')
