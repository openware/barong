    ...
    task fake: :environment do
      ...
      [*1..100].each do
        ...
        [*0..Faker::Number.between(0, 2)].each do |count|
          profile.documents.create(doc_type: Faker::File.extension, doc_number: Faker::Number.number(4), doc_expire: Date.today + count.days, upload: File.open('app/assets/images/logo-black.png'))
        end
      end
